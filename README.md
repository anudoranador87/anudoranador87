...
> Fully responsive, highlighting projects, skills, and daily learning. First thing recruiters see — interactive and live. Projects load dynamically via GitHub API with async/await.
...
[![VS Code](https://img.shields.io/badge/VS_Code-007ACC?style=for-the-badge&logo=visual-studio-code&logoColor=white)](https://img.shields.io/badge/VS_Code-007ACC?style=for-the-badge&logo=visual-studio-code&logoColor=white)
...
| --- | --- | --- | --- |
| ☕ Campus & Crema (React) | React components, useState, Vite, Vercel deploy | React · Vite · CSS | [Demo](https://campus-crema-react.vercel.app/) · [Repo](https://github.com/anudoranador87/campus-crema-react) |
| ☕ Campus & Crema (Vanilla) | Async/await, Weather API, OOP FormValidator, Carousel | HTML · CSS · JS | [Demo](https://anudoranador87.github.io/campus-crema-web/) · [Repo](https://github.com/anudoranador87/campus-crema-web) |
...
## ⚙️ EquiShift — Flagship Project

**Intelligent shift management system** for multi-contract teams in Málaga, Spain.
...
* 🖥️ **Visual dashboard** — full year calendar, KPIs, JSON export
...
> 31 documented study sessions · Started January 18, 2026
...
* **Entry 31 · Apr 14**: Weather API live in Campus & Crema hero — async/await in production, 4 bugs documented
* **Entry 30 · Apr 13**: GitHub API integrated in CV — dynamic project loader with async/await + filter/includes
* **Entry 29 · Apr 11**: 3 Codewars katas — nested ternaries, filter+reduce, spread operator
* **Entry 28 · Apr 10**: Campus & Crema migrated to React + Vite — deployed on Vercel same day
* **Entry 26 · Apr 6**: 18 object exercises — `this`, methods, spread, destructuring, map/join
* **Entry 25 · Mar 5**: 18 array exercises — reduce(), chaining, spread, destructuring
* **Entry 24 · Mar 17 (old)**: EquiShift motor · 365-day loop · modular arithmetic · 104 weekends validated ✅
...
* 🔹 **Crisis management & problem-solving under pressure** — 8 years of proven track record
...
### De la hostelería al Front-End Development 🚀
...
> Totalmente responsive, con proyectos, skills y log diario. Los proyectos se cargan en tiempo real desde la GitHub API con async/await.
...
| --- | --- | --- | --- |
| ☕ Campus & Crema (React) | Componentes React, useState, Vite, deploy Vercel | React · Vite · CSS | [Demo](https://campus-crema-react.vercel.app/) · [Repo](https://github.com/anudoranador87/campus-crema-react) |
| ☕ Campus & Crema (Vanilla) | Async/await, Weather API, OOP FormValidator, Carousel | HTML · CSS · JS | [Demo](https://anudoranador87.github.io/campus-crema-web/) · [Repo](https://github.com/anudoranador87/campus-crema-web) |
...
* 🖥️ **Dashboard visual** — calendario anual completo, KPIs, exportar JSON
...
> 31 sesiones de estudio documentadas · Inicio: 18 de enero de 2026
...
* **Entrada 31 · 14 Abr**: Weather API en vivo en Campus & Crema — async/await en producción, 4 bugs documentados
* **Entrada 30 · 13 Abr**: GitHub API integrada en el CV — carga dinámica con async/await + filter/includes
* **Entrada 29 · 11 Abr**: 3 katas Codewars — ternarios anidados, filter+reduce, spread operator
* **Entrada 28 · 10 Abr**: Campus & Crema migrado a React + Vite — desplegado en Vercel el mismo día
* **Entrada 26 · 6 Abr**: 18 ejercicios de objetos — `this`, métodos, spread, destructuring, map/join
* **Entrada 25 · 5 Mar**: 18 ejercicios de arrays — reduce(), encadenamiento, spread, destructuring
...
## 💡 Soft Skills & Mentalidad

* 🔹 **Resolución de problemas bajo presión** — 8 años de experiencia demostrada
...
> *Si buscas consistencia, resolución real de problemas y alguien que sabe trabajar bajo presión — hablemos.*
